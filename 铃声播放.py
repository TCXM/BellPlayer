...
while 1:
    ...
    print(t)
    if normal == True:
        if t == 715 or t == 805 or t == 855 or t == 1000 or t == 1055 or t == 1145 or t == 1420 or t == 1510 or t == 1615 or t == 1710 or t == 1930 or t == 2030 or t == 2140:
            播放下课铃()
            time.sleep(60)
        if (t == 858  and d != 1) or t == 1513:
            点击麦克风()
            x=1
            T=0
            while T < 900:
        ...
        if t == 645 or t == 725 or t == 815 or t == 920 or t == 1105 or t == 1215 or t == 1340 or t == 1430 or t == 1535 or t == 1750 or t == 1940 or t == 2040:
            播放上课铃()
            time.sleep(60) 
        if t == 1010 or t == 1625:
            播放上课铃()
